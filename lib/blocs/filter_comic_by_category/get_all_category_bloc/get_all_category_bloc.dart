...
class GetAllCategoryBloc extends Bloc<GetAllCategoryEvent,GetAllCategoryState>{
  final CategoryRepo _categoryRepo;
  GetAllCategoryBloc(CategoryRepo categoryRepo):_categoryRepo = categoryRepo,super(GetInitial()){
    on<GetAllCategory>(_getAllCategory);
  }
  Future<void> _getAllCategory(GetAllCategory event,Emitter<GetAllCategoryState> emitter)async{
    emitter(GetLoading());
    try {
